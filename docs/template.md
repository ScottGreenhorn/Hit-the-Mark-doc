...
1. Click Create repository form template
...
5. In the Name your file box, specify a name for the file. If you are creating markdown files, ensure your file mname includes the .md extension.
...
The parent page must contain the following in its YMAL frontmatter:
`has_children: true`
